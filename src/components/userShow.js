      ...
      <div className="d-flex">
        <div className="card justify-content-center">
          ...
          <ul className="list-group list-group-flush">
            ...
            <li className="list-group-item"><strong>City: </strong>{this.props.user.address.city}</li>
            <li className="list-group-item"><strong>ZipCode: </strong> {this.props.user.address.zipcode}</li>
          </ul>
        </div>
      </div>
    );
